...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: X2Zc8-l4JANW_H/component
import Select__Option from "../../Select__Option"; // plasmic-import: 1FeUEftN7bzhvf/component
import NavMenuItemBase from "../../NavMenuItemBase"; // plasmic-import: zQBsHka-k5kj_Z/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: zCNB-XBvTjA-Rk/css

import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: gv7WUlD3TR0v1f/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: Xo7a5302eqAOVr/icon
            ...
            >
              {p.renderPlasmicSlot({
                defaultContents: true ? (
                  <Select__Option
                    className={classNames("__wab_instance", sty.option___8I8Ut)}
              ...
              <NavMenuItemBase
                className={classNames(
                  "__wab_instance",
                  sty.navMenuItemBase__j5Ygj,
                  {
                    [sty.navMenuItemBaseisOpen__j5YgjGwdBo]: hasVariant(
                      variants,
                      "isOpen",
                      "isOpen"
                    )
              ...
              <NavMenuItemBase
                className={classNames(
                  "__wab_instance",
                  sty.navMenuItemBase__j8Pxt,
                  {
                    [sty.navMenuItemBaseisOpen__j8PxtGwdBo]: hasVariant(
                      variants,
                      "isOpen",
                      "isOpen"
                    )
              ...
              <NavMenuItemBase
                className={classNames(
                  "__wab_instance",
                  sty.navMenuItemBase__qRv4T,
                  {
                    [sty.navMenuItemBaseisOpen__qRv4TgwdBo]: hasVariant(
                      variants,
                      "isOpen",
                      "isOpen"
                    )
