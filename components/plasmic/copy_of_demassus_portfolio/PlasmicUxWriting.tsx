...
import sty from "./PlasmicUxWriting.module.css"; // plasmic-import: XscpXaQ_Bo/css
...
export type PlasmicUxWriting__VariantMembers = {};

export type PlasmicUxWriting__VariantsArgs = {};
type VariantPropType = keyof PlasmicUxWriting__VariantsArgs;
export const PlasmicUxWriting__VariantProps = new Array<VariantPropType>();

export type PlasmicUxWriting__ArgsType = {
  children?: React.ReactNode;
};

type ArgPropType = keyof PlasmicUxWriting__ArgsType;
export const PlasmicUxWriting__ArgProps = new Array<ArgPropType>("children");

export type PlasmicUxWriting__OverridesType = {
  root?: p.Flex<"div">;
  handsRandomStuff?: p.Flex<"div">;
};

export interface DefaultUxWritingProps {}

function PlasmicUxWriting__RenderFunc(props: {
  variants: PlasmicUxWriting__VariantsArgs;
  args: PlasmicUxWriting__ArgsType;
  overrides: PlasmicUxWriting__OverridesType;
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          {(
            ...
            <div className={classNames(projectcss.all, sty.freeBox___5GuU)}>
              <div
              ...
              >
                <p.PlasmicImg
                  alt={""}
                  className={classNames(sty.img__wHj8W)}
                  displayHeight={
              ...
              {(
                ...
                <p.PlasmicImg
                  alt={""}
                  className={classNames(sty.img__aeI)}
                  displayHeight={
                    hasVariant(globalVariants, "screen", "mobileOnly")
                      ? ("327px" as const)
                      : ("373px" as const)
          ...
          {true ? (
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__ryJd8)}
            >
              {p.renderPlasmicSlot({
                defaultContents: (
                  <React.Fragment>
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__a2Nt)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicUxWriting__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicUxWriting__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicUxWriting__ArgsType, ReservedPropsType> &
