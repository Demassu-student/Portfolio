...
import sty from "./PlasmicNavMenuItemBase.module.css"; // plasmic-import: 8eZExgQPCQ/css

import NavIconBase2Icon from "./icons/PlasmicIcon__NavIconBase2"; // plasmic-import: d_W2aNfKI/icon
import NavIconBase3Icon from "./icons/PlasmicIcon__NavIconBase3"; // plasmic-import: -_oHFhlz68/icon
import NavIconBaseIcon from "./icons/PlasmicIcon__NavIconBase"; // plasmic-import: vYYAqZjHf4/icon
