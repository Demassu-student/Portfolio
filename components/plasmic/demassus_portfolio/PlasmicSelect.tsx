...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: rhisCgZc5gz/component
import Select__Option from "../../Select__Option"; // plasmic-import: tGGwpP0Zy5t/component
import NavMenuItemBase from "../../NavMenuItemBase"; // plasmic-import: 8eZExgQPCQ/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic_demassus_portfolio.module.css"; // plasmic-import: vrXCB8dxA4nVS6MjHefASJ/projectcss
import sty from "./PlasmicSelect.module.css"; // plasmic-import: 5Mzr4hHPVsU/css

import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: fhFG5yWwxho/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: BqaKDXkOo_k/icon
        ...
        >
          ...
          >
            {(
              ...
              ? p.renderPlasmicSlot({
                  defaultContents: "Selected works",
            ...
            >
              {p.renderPlasmicSlot({
                defaultContents: true ? (
                  <Select__Option
                    className={classNames("__wab_instance", sty.option__vmj5H)}
              ...
              <NavMenuItemBase
                className={classNames(
                  "__wab_instance",
                  sty.navMenuItemBase__lgqvm,
                  {
                    [sty.navMenuItemBaseisOpen__lgqvm8AJle]: hasVariant(
                      variants,
                      "isOpen",
                      "isOpen"
                    )
              ...
              <NavMenuItemBase
                className={classNames(
                  "__wab_instance",
                  sty.navMenuItemBase___5LTs,
                  {
                    [sty.navMenuItemBaseisOpen___5LTs8AJle]: hasVariant(
                      variants,
                      "isOpen",
                      "isOpen"
                    )
              ...
              <NavMenuItemBase
                className={classNames(
                  "__wab_instance",
                  sty.navMenuItemBase__hy54M,
                  {
                    [sty.navMenuItemBaseisOpen__hy54M8AJle]: hasVariant(
                      variants,
                      "isOpen",
                      "isOpen"
                    )
