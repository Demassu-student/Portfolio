...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: 2fDT-cBWlbe/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: 5Mzr4hHPVsU/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option___5Vxzb)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__kGlrR)}
              />
            </React.Fragment>
          ),
          value: args.children
